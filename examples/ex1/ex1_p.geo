...
Transfinite Line {16, 18, 20, 22, 24, 26, 2, 4, 7, 9, 12, 14} = 4 Using Progression 1;
Transfinite Line {1, 6, 11, 5, 10, 15} = 4 Using Progression 1;
Transfinite Line {17, 19, 21, 23, 25, 27, 3, 8} = 2 Using Progression 1;
...
Recombine Surface {37, 39, 41, 43, 45};
