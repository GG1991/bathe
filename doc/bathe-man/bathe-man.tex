...
\title{\Huge \textbf{BATHE}\\ \huge Code for solid structure simulation}
% Author
...
\bibitem{arclength_borst}
S.~May, J.~Vignollet and R.~Borst \emph{A new arc-length control method based on the rates of the internal energy and
the dissipated energy}, 2015.

\bibitem{bathe_fem}
K.J.~Bathe, \emph{Finite Element Procedures}, 2nd~edition. Prentice Hall, Pearson Education, 2016.

\bibitem{oller_damage}
J. Oliver, M. Cervera, S.~Oller and Lubliner, \emph{Isotropic Damage Models and Smeared Crack Analysis of Concrete},
Second International Conference On Computer Aided Analysis and Design of Concrete Structures, 1990.

\bibitem{oller_fractura}
S.~Oller, \emph{Fractura Mec\'anica, un enfoque global}, 1era~edici\'on. Centro Internacional de M\'etodos Num\'ericos en Ingenier\'ia, Barcelona, Espa\~na, (CIMNE), 2001.

\bibitem{oller_din_no_l}
S.~Oller, \emph{Din\'amica No-Lineal}, 1era~edici\'on. Centro Internacional de M\'etodos Num\'ericos en Ingenier\'ia, Barcelona, Espa\~na, (CIMNE), 2002.
